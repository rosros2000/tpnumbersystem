...
\title{Power-based number system glossary \\[1ex]{\HHUGE{\tpf lipu-nimi pi nasin nanpa sewi1}} \\ V 0.12 $\alpha$} 
...
\tpDef {gram}{poki}{poki}{g}

\tpDef {kilogram}{poki sewi1 sin}{poki sewi sin}{kg, $10^{3}$\,g}

\tpDef {ton}{poki sewi1 suli}{poki sewi suli}{t, $10^{9}$\,g}
