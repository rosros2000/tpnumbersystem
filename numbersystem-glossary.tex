...
\title{Power-based number system glossary \\[1ex]{\HHUGE{\tpf lipu-nimi pi nasin nanpa sewi1}} \\ V 0.03 $\alpha$} 
...
\tpDef {Monday}{tenpo suno mun}{tenpo suno mun}{the first [ISO-8601] day of the week; cf. \textit{tenpo suno nanpa wan pi tempo sike}: new year's, the first day of the year;}
