...
\subsection{Very large (or small) numbers}
   ...
   \textbf{ Very large (or small) numbers can be expressed easily.}
	...
	{\sitp{5-12 la ona li kama lon}}~<\emph{tenpo mun luka en tenpo suno wan tu la ona li kama lon}> His birthday is May 12th
...
In other to reduce the conflict with other toki-pona number systems, the numbers could be written with the usual digits (0-9), i.e. not using toki pona numerals.
